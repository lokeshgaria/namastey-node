...
async function sendFailureEmailTemplated(emailUser, errorDesc, orderId) {
...
function createIdentity(identityName) {
...
function createReceiptFilter(receiptFilterName) {
...
function createReceiptRuleSet(ruleSetName) {
...
function deleteIdentity(identityName) {
...
function deleteReceiptFilter(receiptFilterName) {
...
function deleteReceiptRuleSet(ruleSetName) {
...
async function findIdentity(identityName) {
...
async function findReceiptFilter(receiptFilterName) {
...
async function findReceiptRuleSet(name) {
  ...
  return result.RuleSets.find((rs) => rs.Name === name)
}
